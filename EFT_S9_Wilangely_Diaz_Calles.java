 ...
 */
package eft_s9_wilangely_diaz_calles;
 ...
 * @author wdiaz
 */
public class EFT_S9_Wilangely_Diaz_Calles {
   ...
   static Scanner sc = new Scanner(System.in);
        ...
        do{
            ...
            try{
                ...
                if (edad<=18){
                    ...
                    System.out.println("\nEres persona de la 3era edad, cuentas con un dcto del 25%");
    
}
                System.out.println("Indicanos tu genero (F/M)");
                   String genero = sc.nextLine();
                   sc.nextLine();
                   if (genero.equalsIgnoreCase("F")){
                       System.out.println("\n cuentas con un descuento promocional del 20%");
                   }
                System.out.println("¿Eres estudiante? (S/N)");
                String esEstudiante = sc.nextLine();
                sc.nextLine();
                   if (esEstudiante.equalsIgnoreCase("S")){
                       System.out.println("\n Felicidades! por ser estudiante cuentas con un descuento adicional del 15%");
                   }
                ...
                SeleccionAsiento(sc, nombreCliente, nombreEvento, precioBase, ubicacion, genero, esEstudiante);
    ...
    public static double calcularDescuentos (String genero, String esEstudiante){
...
public static void SeleccionAsiento (Scanner sc, String nombreCliente, String nombreEvento, int precioBase, String ubicacion, String genero, String esEstudiante){
    int cantidad =0;
        ...
        for (int i = 0; i < asientos.length; i++){
            for (int j =0; j < asientos[i].length; j++){
                if (asientos[i][j]){
                    ...
                    double descuentoAplicado = calcularDescuentos(genero, esEstudiante);
        ...
        do{
            ...
            switch (opcion){
                ...
                case 3:
                    ...
                    System.out.println("\n----Asientos reservados actualmente----");
